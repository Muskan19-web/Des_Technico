...
public class NoteMaster {
	...
	public void signUp() {
		...
		Email.sendKeys("khushipatel59946@gmail.com");
	...
	public void logIn() throws InterruptedException {
		...
		emailInput.sendKeys("khushipatel59946@gmail.com");
	...
	public void WriteNotes() throws InterruptedException {
		...
		// Wait for 5 seconds for the next step
		Thread.sleep(5000);
		
		// Click on Edit button
		WebElement EditBtn = driver.findElement(By.xpath("(//*[@class=\'flex items-center justify-center\'])[3]"));
		EditBtn.click();
		
		// Wait for 3 seconds
		Thread.sleep(3000);
		
		// Using JavaScrip for Scroll
		JavascriptExecutor ScrollForDelete = (JavascriptExecutor)driver;
		ScrollForDelete.executeScript("window.scroll(0,500);");
		
		Thread.sleep(3000);
		// Click on Delete the note
		WebElement Delete = driver.findElement(By.xpath("(//*[@class=\'flex items-center justify-center\'])[3]"));
		Delete.click();
